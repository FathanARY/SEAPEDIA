  ...
  const fetchProduct = async (productId: string) => {
    try {
      ...
      if (res.ok) {
        ...
        setError('Gagal memuat produk. Mungkin produk ini tidak ada atau bukan milik Anda.');
      }
    } catch (err) {
  ...
  return (
    <main className="flex-1 max-w-4xl mx-auto w-full animate-fade-in pb-xl">
      ...
      <div className="flex items-center gap-md mb-xl">
        ...
        <div>
          <h1 className="text-headline-lg-mobile md:text-headline-lg font-headline-lg-mobile md:font-headline-lg text-on-surface">Edit Produk</h1>
          <p className="text-body-md font-body-md text-on-surface-variant mt-xs">Perbarui detail, harga, atau stok produk Anda.</p>
        </div>
      </div>
